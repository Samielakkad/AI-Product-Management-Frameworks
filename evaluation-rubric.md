...
- **Adversarial robustness.** Adversarial queries are evaluated separately, see [`ernie-evaluation-notes/adversarial_pairs.md`](https://github.com/Samielakkad/ernie-evaluation-notes/blob/main/adversarial_pairs.md).
...
- **Adversarial set construction:** see [`ernie-evaluation-notes/adversarial_pairs.md`](https://github.com/Samielakkad/ernie-evaluation-notes/blob/main/adversarial_pairs.md)
- **Eval runner code:** see [`jak-ma-eval-suite/scripts/run_eval.py`](https://github.com/Samielakkad/jak-ma-eval-suite/blob/main/scripts/run_eval.py)
- **System architecture:** see [`jak-ma-eval-suite/docs/architecture.md`](https://github.com/Samielakkad/jak-ma-eval-suite/blob/main/docs/architecture.md)
