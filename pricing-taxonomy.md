...
This document is the operational playbook for building the rule table that catches that. It is the framework behind the [`V4` price-fairness check](https://github.com/Samielakkad/jak-ma-eval-suite/blob/main/VERIFIER_SPEC.md) in the jak.ma verifier.
