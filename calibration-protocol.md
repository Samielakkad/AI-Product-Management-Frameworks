...
- **Adversarial set construction (uses the same calibration approach):** [`ernie-evaluation-notes/calibration_practice.md`](https://github.com/selakkad2003/ernie-evaluation-notes/blob/main/calibration_practice.md)
