...
The deterministic verifier has six independent checks. Each is < 1ms to compute. The full spec is in [VERIFIER_SPEC.md](https://github.com/Samielakkad/jak-ma-eval-suite/blob/main/VERIFIER_SPEC.md).
...
- **The actual checks:** [`jak-ma-eval-suite/VERIFIER_SPEC.md`](https://github.com/Samielakkad/jak-ma-eval-suite/blob/main/VERIFIER_SPEC.md)
...
- **System architecture:** [`jak-ma-eval-suite/docs/architecture.md`](https://github.com/Samielakkad/jak-ma-eval-suite/blob/main/docs/architecture.md)
