...
- **System architecture (where the image fits):** [`jak-ma-eval-suite/docs/architecture.md`](https://github.com/selakkad2003/jak-ma-eval-suite/blob/main/docs/architecture.md)
- **Cost model:** [`jak-ma-eval-suite/docs/cost_model.md`](https://github.com/selakkad2003/jak-ma-eval-suite/blob/main/docs/cost_model.md)
- **Latency budget:** [`jak-ma-eval-suite/docs/latency_budget.md`](https://github.com/selakkad2003/jak-ma-eval-suite/blob/main/docs/latency_budget.md)
